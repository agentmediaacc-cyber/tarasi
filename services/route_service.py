...
def _normalise_route(row):
    ...
    return {
        ...
        "hotspot_lat": row.get("hotspot_lat") or row.get("stop_lat") or row.get("landmark_lat"),
        "hotspot_lng": row.get("hotspot_lng") or row.get("stop_lng") or row.get("landmark_lng"),
        "hotspot_name": row.get("hotspot_name") or row.get("landmark") or row.get("popular_stop") or "",
        "route_polyline": row.get("route_polyline") or row.get("polyline") or row.get("route_path") or "",
        "map_notes": row.get("map_notes") or row.get("travel_notes") or "",
        "live_status": row.get("live_status") or row.get("availability_status") or "Available",
    }
