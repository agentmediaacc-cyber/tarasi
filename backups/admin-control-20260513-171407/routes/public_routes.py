...
from services.booking_service import get_booking_context
...
@public_bp.route("/")
def home():
    return render_template("tarasi_home_premium.html")
...
def book():
    ...
    return render_template(
        ...
        fleet=ctx.get("fleet", []),
        packages_count=ctx.get("packages_count", 0),
        routes_count=ctx.get("routes_count", 0),
        fleet_count=ctx.get("fleet_count", 0),
