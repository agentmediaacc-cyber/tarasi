...
def home():
    routes = [
        {"name": "Windhoek to Hosea Kutako Airport", "category": "Airport transfer", "price": "850"},
        {"name": "Windhoek to Swakopmund", "category": "Coastal route", "price": "950"},
        {"name": "Windhoek to Etosha", "category": "Safari route", "price": "1800"},
        {"name": "Windhoek to Sossusvlei", "category": "Desert route", "price": "1650"},
    ]
    fleet = [
        {"name": "Toyota Quantum", "type": "Shuttle Van", "seats": "14"},
        {"name": "Executive SUV", "type": "VIP SUV", "seats": "6"},
        {"name": "Minibus", "type": "Group Transport", "seats": "22"},
    ]
    return render_template(
        "index.html",
        routes=routes,
