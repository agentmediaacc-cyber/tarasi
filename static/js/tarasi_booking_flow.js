(function () {
  ...
  const pricingBreakdown = form.querySelector(".tarasi-pricing-breakdown");
  ...
  function renderEstimate(data) {
    ...
    if (pricingBreakdown) {
      pricingBreakdown.hidden = true;
    }

    const notes = data.short_note || (Array.isArray(data.notes) ? data.notes.join(" ") : (data.notes || "Pricing notes not available."));
